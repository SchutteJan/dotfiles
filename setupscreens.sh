options=('Laptop only' 'Monitor + Laptop' 'TV only' 'TV + Laptop' 'Automatic')
...
#    xrandr --fb 3584x3816 --output eDP1 --mode 3200x1800 --pos 128x2016 --output DP1 --mode 2560x1440 --pos 0x0 --scale 1.4x1.4
    ...
    xrandr --fb 3584x3816 --output eDP1 --mode 3200x1800 --pos 128x2016 --output HDMI1 --mode 2560x1440 --pos 0x0 --scale 1.4x1.4
